            ...
            <form  action="" className="space-y-12">
                <div className="space-y-4">
                    <div>
                        ...
                        <input type="text" name="username" id="username" placeholder="leroy jenkins" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100" required/>
                    </div>
                    <div>
